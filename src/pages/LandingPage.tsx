...
const LandingPage: React.FC = () => {
  ...
  // For non-authenticated users, show only the hero section
  if (!isAuthenticated) {
    ...
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 to-secondary-600 text-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          {!isAuthenticated && (
            <button className="bg-accent-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-accent-600 transition-colors text-lg">
