...
const OnboardingChatbot: React.FC = () => {
  ...
  const onboardingSteps = [
    {
      id: 'welcome',
      botMessage: `Hey there! 👋 I'm TechBot, your personal learning assistant. I'm here to help personalize your TechLearn experience! 
...
Tell me a bit about yourself. What's your background or what brings you to TechLearn?`,
      inputType: 'text' as const,
      field: 'bio',
...
What are your main goals for learning on TechLearn? (Select all that apply)`,
      inputType: 'multiselect' as const,
      field: 'goals',
      options: goalOptions
    },
...
Welcome to TechLearn, {name}! Ready to start your tech journey? 🚀`,
  ...
  const saveUserProfile = async (profileData: UserProfile) => {
    ...
    try {
      ...
      // Add success message
      addBotMessage('✅ Your profile has been saved successfully! Welcome to TechLearn!');
